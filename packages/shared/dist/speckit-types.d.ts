...
export type SpecKitPhase = 'init' | 'check' | 'version' | 'constitution' | 'specify' | 'clarify' | 'plan' | 'checklist' | 'tasks' | 'analyze' | 'implement';
...
export interface SpecKitArtifactRef {
    /** Art des Artefakts */
    kind: 'constitution' | 'spec' | 'plan' | 'tasks' | 'research' | 'checklist' | 'contract' | 'data-model' | 'quickstart' | 'unknown';
