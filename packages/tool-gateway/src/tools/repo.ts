...
export const repoReadFileHandler: ToolHandler = async (
  call,
): Promise<ToolResult> => {
  try {
...
export const repoListFilesHandler: ToolHandler = async (
  call,
): Promise<ToolResult> => {
  try {
...
export const repoGetDiffHandler: ToolHandler = async (
  call,
): Promise<ToolResult> => {
  try {
    let diff: string;
