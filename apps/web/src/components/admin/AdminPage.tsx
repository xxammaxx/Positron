          ...
          <div className="space-y-4">
            <div className="card">
              ...
              <div className="flex flex-wrap gap-3">
                <button onClick={() => bulkAction('cancel', 'Cancel All')} className="btn-danger text-sm">
                  Cancel All Active/Blocked
                </button>
                <button onClick={() => bulkAction('retry', 'Retry Failed')} className="btn-secondary text-sm">
                  Retry All Failed
                </button>
                <button onClick={() => bulkAction('cleanup', 'Cleanup')} className="btn-ghost text-sm">
