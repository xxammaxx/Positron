...
(() => {
	...
	var ho = (e, t, r) =>
			t in e ? _r(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r),
		P = (e, t) => {
	...
	var vo = (e, t) => {
		...
		if (e != null && Bt) for (var o of Bt(e)) t.indexOf(o) < 0 && bo.call(e, o) && (r[o] = e[o]);
		return r;
	};
	...
	var oa = (e, t, r, o) => {
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (let n of ta(t))
				!Ar.call(e, n) &&
					n !== r &&
					_r(e, n, { get: () => t[n], enumerable: !(o = ea(t, n)) || o.enumerable });
		return e;
	};
	var $t = (e, t, r) => (
		(r = e != null ? Zi(ra(e)) : {}),
		oa(t || !e || !e.__esModule ? _r(r, 'default', { value: e, enumerable: !0 }) : r, e)
	);
	var go = (e, t, r) =>
		new Promise((o, n) => {
			var i = (c) => {
			...
			function e(r) {
				...
				function p(k) {
					k.classList.contains('focus-visible') ||
						(k.classList.add('focus-visible'), k.setAttribute('data-focus-visible-added', ''));
				}
				function l(k) {
					k.hasAttribute('data-focus-visible-added') &&
						(k.classList.remove('focus-visible'), k.removeAttribute('data-focus-visible-added'));
				}
				function f(k) {
					k.metaKey ||
						k.altKey ||
				...
				function ee(k) {
					(k.target.nodeName && k.target.nodeName.toLowerCase() === 'html') || ((o = !1), re());
				}
			...
			return (function () {
				var e = {
						686: function (o, n, i) {
							...
							var ut = function () {
									...
									if (G !== void 0)
										if (G && k(G) === 'object' && G.nodeType === 1) {
											...
											if (D === 'cut' && (G.hasAttribute('readonly') || G.hasAttribute('disabled')))
												throw new Error(
							...
							function se(q, C) {
								if (!(q instanceof C)) throw new TypeError('Cannot call a class as a function');
							}
							function ce(q, C) {
							...
							function Yi(q, C) {
								return C && (R(C) === 'object' || typeof C == 'function') ? C : Bi(q);
							}
							function Bi(q) {
								if (q === void 0)
							...
							var Ji = (function (q) {
									...
									function _(D, N) {
										var G;
										return (
											se(this, _), (G = C.call(this)), G.resolveOptions(N), G.listenClick(D), G
										);
									}
									return (
										he(
											...
											[
												{
													...
													value: function () {
														...
														(this.action =
															typeof N.action == 'function' ? N.action : this.defaultAction),
															(this.target =
																typeof N.target == 'function' ? N.target : this.defaultTarget),
															(this.text = typeof N.text == 'function' ? N.text : this.defaultText),
															(this.container =
																R(N.container) === 'object' ? N.container : document.body);
													},
												},
												{
													key: 'listenClick',
						...
						438: function (o, n, i) {
							...
							function p(l, f, u, d) {
								return function (v) {
									(v.delegateTarget = s(v.target, f)), v.delegateTarget && d.call(l, v);
								};
							}
							o.exports = c;
						},
						...
						370: function (o, n, i) {
							var s = i(879),
								a = i(438);
							function c(u, d, v) {
								if (!u && !d && !v) throw new Error('Missing required arguments');
								if (!s.string(d)) throw new TypeError('Second argument must be a String');
								if (!s.fn(v)) throw new TypeError('Third argument must be a Function');
						...
						817: function (o) {
							function n(i) {
								...
								if (i.nodeName === 'SELECT') i.focus(), (s = i.value);
									...
									p.selectNodeContents(i), c.removeAllRanges(), c.addRange(p), (s = c.toString());
								}
								return s;
							}
							o.exports = n;
			...
			for (; s && ((s = 0), p[0] && (r = 0)), r; )
				try {
					...
					switch (((n = 0), i && (p = [p[0] & 2, i.value]), p[0])) {
						...
						default:
							if (
								((i = r.trys), !(i = i.length > 0 && i[i.length - 1]) && (p[0] === 6 || p[0] === 2))
							) {
								r = 0;
								continue;
							}
	...
	function wo(e, t, r) {
		...
		function p(d) {
			d.value instanceof dt ? Promise.resolve(d.value.v).then(l, f) : u(i[0][2], d);
		}
		function l(d) {
			c('next', d);
		}
...
` +
  ...
  `)
						...
						try {
							for (var u = Oe(f), d = u.next(); !d.done; d = u.next()) {
								...
								try {
									...
									(i = i != null ? i : []),
										S instanceof Jt ? (i = B(B([], K(i)), K(S.errors))) : i.push(S);
								}
							}
						} catch (S) {
							o = { error: S };
	...
	var $r = qe.EMPTY;
	function Xt(e) {
		return e instanceof qe || (e && 'closed' in e && I(e.remove) && I(e.add) && I(e.unsubscribe));
	}
	function So(e) {
		I(e) ? e() : e.unsubscribe();
	}
	...
	function _o(e) {
		De.useDeprecatedSynchronousErrorHandling && ht && ((ht.errorThrown = !0), (ht.error = e));
	}
	var Pt = (function (e) {
		ie(t, e);
		function t(r) {
			...
			return (
				(o.isStopped = !1), r ? ((o.destination = r), Xt(r) && r.add(o)) : (o.destination = sa), o
			);
		}
		return (
			...
			(t.prototype.error = function (r) {
				this.isStopped ? Ir(Lo(r), this) : ((this.isStopped = !0), this._error(r));
			}),
			(t.prototype.complete = function () {
				this.isStopped ? Ir(Oo, this) : ((this.isStopped = !0), this._complete());
			}),
	...
	function Co(e) {
		var t;
		return (t = e != null ? e : De.Promise) !== null && t !== void 0 ? t : Promise;
	}
	function ca(e) {
	...
	var Tt = {
		...
		requestAnimationFrame: function () {
			for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
			var r = Tt.delegate;
			return ((r == null ? void 0 : r.requestAnimationFrame) || requestAnimationFrame).apply(
				void 0,
				B([], K(e)),
			);
		},
		cancelAnimationFrame: function () {
			for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
			var r = Tt.delegate;
			return ((r == null ? void 0 : r.cancelAnimationFrame) || cancelAnimationFrame).apply(
				void 0,
				B([], K(e)),
			);
		},
			...
			(t.prototype.next = function (r) {
				...
				Et(function () {
					...
					if ((o._throwIfClosed(), !o.isStopped)) {
						...
						try {
							for (var s = Oe(o.currentObservers), a = s.next(); !a.done; a = s.next()) {
								var c = a.value;
								c.next(r);
							}
						} catch (p) {
	...
	var Ho = (function (e) {
		...
		return (
			(t.prototype.next = function (r) {
				var o, n;
				(n = (o = this.destination) === null || o === void 0 ? void 0 : o.next) === null ||
					n === void 0 ||
					n.call(o, r);
			}),
			(t.prototype.error = function (r) {
				var o, n;
				(n = (o = this.destination) === null || o === void 0 ? void 0 : o.error) === null ||
					n === void 0 ||
					n.call(o, r);
			}),
			(t.prototype.complete = function () {
				var r, o;
				(o = (r = this.destination) === null || r === void 0 ? void 0 : r.complete) === null ||
					o === void 0 ||
					o.call(r);
			}),
			(t.prototype._subscribe = function (r) {
				var o, n;
				return (n = (o = this.source) === null || o === void 0 ? void 0 : o.subscribe(r)) !==
					null && n !== void 0
					? n
					: $r;
			}),
	...
	var It = (function (e) {
		ie(t, e);
		function t(r, o, n) {
			r === void 0 && (r = 1 / 0), o === void 0 && (o = 1 / 0), n === void 0 && (n = Rt);
			var i = e.call(this) || this;
			return (
				(i._bufferSize = r),
				(i._windowTime = o),
		...
		return (
			...
			(t.prototype._trimBuffer = function () {
				...
				if ((o < 1 / 0 && a < i.length && i.splice(0, i.length - a), !s)) {
					for (var c = n.now(), p = 0, l = 1; l < i.length && i[l] <= c; l += 2) p = l;
					p && i.splice(0, p + 1);
				}
			}),
			t
		...
		return (
			(t.prototype.schedule = function (r, o) {
				...
				return (
					...
					(this.delay = o),
					(this.id =
						(n = this.id) !== null && n !== void 0 ? n : this.requestAsyncId(s, this.id, o)),
					this
				);
			}),
			(t.prototype.requestAsyncId = function (r, o, n) {
				return n === void 0 && (n = 0), Ft.setInterval(r.flush.bind(r, this), n);
			}),
	...
	var Ur = (function () {
		...
		return (
			(e.prototype.schedule = function (t, r, o) {
				return r === void 0 && (r = 0), new this.schedulerActionCtor(this, t).schedule(o, r);
			}),
			(e.now = Rt.now),
			e
		);
			...
			(t.prototype.schedule = function (r, o) {
				return (
					...
					o > 0
						...
						: ((this.delay = o), (this.state = r), this.scheduler.flush(this), this)
				);
			}),
			(t.prototype.execute = function (r, o) {
	...
	var Io = (function (e) {
		...
		return (
			...
			(t.prototype.recycleAsyncId = function (r, o, n) {
				...
				o != null &&
					o === r._scheduled &&
					((i = s[s.length - 1]) === null || i === void 0 ? void 0 : i.id) !== o &&
			...
			return Gt(this, function (s) {
				switch (s.label) {
					...
					case 2:
						return [4, dt(r.read())];
					case 3:
						return (o = s.sent()), (n = o.value), (i = o.done), i ? [4, dt(void 0)] : [3, 5];
					case 4:
						return [2, s.sent()];
					case 5:
						return [4, dt(n)];
		...
		return Eo(this, void 0, void 0, function () {
			...
			return Gt(this, function (c) {
				switch (c.label) {
					...
					case 6:
						return (
							c.trys.push([6, , 9, 10]), o && !o.done && (i = r.return) ? [4, i.call(r)] : [3, 8]
						);
					case 7:
						c.sent(), (c.label = 8);
					case 8:
										...
										function () {
											...
											f.subscribe(
												w(
													o,
													function (d) {
														(i[l] = d), u || ((u = !0), a--), a || o.next(r(i.slice()));
													},
													function () {
														--s || o.complete();
													},
		...
		return (
			...
			new F(function (n) {
				...
				return r.schedule(function () {
					n.closed || (n.next(s++), 0 <= o ? this.schedule(void 0, o) : n.complete());
				}, i);
			})
		);
	}
						...
						function (s) {
							...
							try {
								for (var u = Oe(n), d = u.next(); !d.done; d = u.next()) {
									var v = d.value;
									v.push(s), e <= v.length && ((f = f != null ? f : []), f.push(v));
								}
							} catch (re) {
								a = { error: re };
							} finally {
		...
		return E(function (t, r) {
			...
			(o = t.subscribe(
				w(r, void 0, void 0, function (s) {
					(i = U(e(s, ve(e)(t)))), o ? (o.unsubscribe(), (o = null), i.subscribe(r)) : (n = !0);
				}),
			)),
			...
			? E(function (n, i) {
					...
					n.subscribe(
						w(
							...
							function (c) {
								var p;
								(p = o.next) === null || p === void 0 || p.call(o, c), i.next(c);
							},
							function () {
								var c;
								(a = !1), (c = o.complete) === null || c === void 0 || c.call(o), i.complete();
							},
							function (c) {
								var p;
								(a = !1), (p = o.error) === null || p === void 0 || p.call(o, c), i.error(c);
							},
							function () {
								var c, p;
								a && ((c = o.unsubscribe) === null || c === void 0 || c.call(o)),
	...
	function on(e, t) {
		return E(function (r, o) {
			var n = t != null ? t : {},
				...
				u = !1,
				d = function () {
					f == null || f.unsubscribe(), (f = null), c && (X(), u && o.complete());
				},
				v = function () {
					(f = null), u && o.complete();
				},
					...
					p = function (f) {
						U(e[f]).subscribe(
							w(
								n,
								function (u) {
									(s[f] = u), !c && !a[f] && ((a[f] = !0), (c = a.every(be)) && (a = null));
								},
								ge,
							),
						);
	...
	function an() {
		let e = new It(1);
		return h(document, 'DOMContentLoaded', { once: !0 }).subscribe(() => e.next(document)), e;
	}
	...
	function Ne() {
		...
		return (o =
			(r =
				(t = (e = document.activeElement) == null ? void 0 : e.shadowRoot) == null
					? void 0
	...
	function it(e, t) {
		return H(() =>
			L(h(e, 'mouseenter').pipe(m(() => !0)), h(e, 'mouseleave').pipe(m(() => !1))).pipe(
				t ? jt((r) => He(+!r * t)) : be,
				Q(e.matches(':hover')),
			),
		);
		...
		if (t)
			for (let n of Object.keys(t))
				typeof t[n] != 'undefined' &&
					(typeof t[n] != 'boolean' ? o.setAttribute(n, t[n]) : o.setAttribute(n, ''));
	...
	function _t(e) {
		...
		return H(
			() => (
				...
				L(
					h(t, 'load'),
					h(t, 'error').pipe(b(() => Nr(() => new ReferenceError(`Invalid script: ${e}`)))),
				).pipe(
					m(() => {}),
	...
	var yr = { drawer: j('[data-md-toggle=drawer]'), search: j('[data-md-toggle=search]') };
	function dn(e) {
		return yr[e].checked;
	}
	function at(e, t) {
			...
			return (
				...
				typeof (t == null ? void 0 : t.progress$) != 'undefined' &&
					(o.addEventListener('progress', (n) => {
						var i;
						if (n.lengthComputable) t.progress$.next((n.loaded / n.total) * 100);
						else {
							let s = (i = o.getResponseHeader('Content-Length')) != null ? i : 0;
	...
	function Tn() {
		return L(h(window, 'scroll', { passive: !0 }), h(window, 'resize', { passive: !0 })).pipe(
			m(wn),
			Q(wn()),
		);
	}
			...
			x(
				...
				e.tags &&
					x(
						...
						{ class: 'md-tags' },
						e.tags.map((c) => {
							let p = a ? (c in a ? `md-tag-icon md-tag--${a[c]}` : 'md-tag-icon') : '';
	...
	function no(e) {
		...
		return x(
			'div',
			{ class: t, hidden: !0 },
			x('button', { class: 'tabbed-button', tabIndex: -1, 'aria-hidden': 'true' }),
		);
	}
	function Un(e) {
		return x(
		...
		return H(() => {
			...
			return (
				...
				z([a.pipe(g((l) => l)), c]).subscribe(([l, f]) => {
					f.role === 'dialog'
						? (e.setAttribute('aria-controls', i), e.setAttribute('aria-haspopup', 'dialog'))
				...
				h(n, 'mousedown')
					...
					.subscribe(([a, { active: c }]) => {
						...
						if (a.button !== 0 || a.metaKey || a.ctrlKey) a.preventDefault();
							...
							l instanceof HTMLElement ? l.focus() : (p = Ne()) == null || p.blur();
						}
					}),
				r
					.pipe(
	...
	function Tr(e, t, { target$: r, print$: o }) {
		...
		for (let a of Xa(t)) {
			...
			ue(`:scope > li:nth-child(${c})`, e) && (s.set(c, kn(c, i)), a.replaceWith(s.get(c)));
		}
		return s.size === 0
			? y
			: H(() => {
					let a = new T(),
						c = a.pipe(oe(), ae(!0)),
						p = [];
					for (let [l, f] of s) p.push([j('.md-typeset', f), j(`:scope > li:nth-child(${l})`, e)]);
					return (
		...
		let { matches: r } = matchMedia('(hover)'),
			o = H(() => {
				...
				n.subscribe(({ scrollable: d }) => {
					d && r ? e.setAttribute('tabindex', '0') : e.removeAttribute('tabindex');
				});
				let s = [],
					a = e.closest('pre'),
					c = a.closest('[id]'),
				...
				if (
					...
					e.closest('.select') || (V('content.code.select') && !e.closest('.no-select')))
				) {
					...
					let re = fe(u).pipe(
						...
						ee = S.pipe(
							...
							m(([R, se]) => {
								...
								{
									let Se = M('.hll', e).map((Ue) => u.indexOf(Ue.parentElement) + d);
									return (
					...
					k.subscribe((R) => {
						...
						for (let Se of M('.hll:not(.select)', e)) Se.replaceWith(...Array.from(Se.childNodes));
							...
							if (R.includes(':')) {
								...
								se &&
									setTimeout(() => {
										let ce = se,
											he = -64;
										for (; ce !== document.body; ) (he += ce.offsetTop), (ce = ce.offsetParent);
					...
					let je = fe(M('a[href^="#__codelineno"]', f))
						...
						.pipe(
							...
							m(([R, se]) => {
								...
								{
									let Se = M('.hll', e).map((Ue) => +Ue.parentElement.id.split('-').pop());
						...
						R[0] === R[1] ? (se += R[0]) : (se += `${R[0]}:${R[1]}`),
							...
							window.dispatchEvent(
								new HashChangeEvent('hashchange', {
									newURL: window.location.origin + window.location.pathname + se,
				...
				if (
					...
					(e.closest('.copy') || (V('content.code.copy') && !e.closest('.no-copy')))
				) {
					let d = Hn(a.id);
	...
	function rs(e) {
		...
		for (; o && !(o instanceof HTMLHeadingElement); ) r.push(o), (o = o.nextElementSibling);
		return r;
	}
	function os(e, t) {
	...
	function Jn(e, t) {
		...
		if (!(V('navigation.instant.preview') || e.hasAttribute('data-preview'))) return y;
		e.removeAttribute('title');
	...
	function ss(e) {
		...
		return L(...e.map((r) => h(r, 'change').pipe(m(() => j(`label[for="${r.id}"]`))))).pipe(
			Q(j(`label[for="${t.id}"]`)),
			m((r) => ({ active: r })),
		);
	}
		...
		return (
			...
			H(() => {
				...
				for (let p of n) {
					...
					l.replaceChildren(
						x('a', { href: `#${l.htmlFor}`, tabIndex: -1 }, ...Array.from(l.childNodes)),
					),
				...
				return (
					V('content.tabs.link') &&
						a.pipe(Ie(1), te(t)).subscribe(([{ active: p }, { offset: l }]) => {
							...
							if (p.hasAttribute('data-md-switching')) p.removeAttribute('data-md-switching');
							else {
					...
					a.pipe(W(c)).subscribe(() => {
						for (let p of M('audio, video', e))
							p.offsetWidth && p.autoplay ? p.play().catch(() => {}) : p.pause();
					}),
					ss(n).pipe(
						O((p) => a.next(p)),
						A(() => a.complete()),
	...
	function oi(e, t) {
		...
		return L(
			...M('.annotate:not(.highlight)', e).map((i) => zn(i, { target$: o, print$: n })),
			...M('pre:not(.mermaid) > code', e).map((i) => Yn(i, { target$: o, print$: n })),
			...M('a', e).map((i) => Jn(i, t)),
					...
					Vt(i, {
						content$: new F((s) => {
							let a = new URL(i.href).hash.slice(1),
								c = Array.from(document.getElementById(a).cloneNode(!0).children),
								p = wr(...c);
	...
	function cs(e, { alert$: t }) {
		return t.pipe(
			b((r) => L($(!0), $(!1).pipe(nt(2e3))).pipe(m((o) => ({ message: r, active: o })))),
		);
	}
	function ni(e, t) {
		...
		return z([i, n]).pipe(
			m(([s, a]) => {
				...
				return (
					...
					{ active: s, offset: { x: c - a.x + l.width / 2 - r / 2, y: p - a.y + l.height + 8 } }
				);
			}),
		);
	}
			...
			H(() => {
				...
				return (
					i.subscribe({
						...
						complete() {
							o.style.removeProperty('--md-tooltip-x'), o.style.removeProperty('--md-tooltip-y');
						},
					}),
					L(
						i.pipe(g(({ active: s }) => s)),
						...
						next({ active: s }) {
							s
								? (e.insertAdjacentElement('afterend', o),
									...
									e.removeAttribute('title'))
								: (o.remove(), e.removeAttribute('aria-describedby'), e.setAttribute('title', t));
						},
						complete() {
							o.remove(), e.removeAttribute('aria-describedby'), e.setAttribute('title', t);
						},
	...
	function si(e, { header$: t, main$: r }) {
		return H(() => {
			let o = new T(),
				n = o.pipe(oe(), ae(!0));
			o.pipe(ne('active'), Pe(t)).subscribe(([{ active: s }, { hidden: a }]) => {
	...
	function pi(e, { viewport$: t, header$: r }) {
		let o = r.pipe(
			...
			n = o.pipe(
				b(() =>
					Le(e).pipe(
						m(({ height: i }) => ({ top: e.offsetTop, bottom: e.offsetTop + i })),
						ne('bottom'),
					),
				),
			);
		return z([o, n, t]).pipe(
			...
			Y((i, s) => i.offset === s.offset && i.height === s.height && i.active === s.active),
		);
	}
	function us(e) {
					...
					b((r) => {
						if (r.target instanceof Element) {
							...
							if (o && !o.target) {
								...
								p = `${i}/${p}`;
								let l = s.has(p.split('#')[0]) ? new URL(p, c.base) : new URL(i);
		...
		co.default.isSupported() &&
			new F((t) => {
				new co.default('[data-clipboard-target], [data-clipboard-text]', {
					text: (r) =>
						r.getAttribute('data-clipboard-text') || hs(j(r.getAttribute('data-clipboard-target'))),
	...
	function hi(e, t) {
		...
		return (o.search = o.hash = ''), t.has(`${o}`) ? (e.preventDefault(), $(r)) : y;
	}
	function bi(e) {
		let t = new Map();
	...
	function bs(e) {
		...
		let t = bi(document);
		for (let [o, n] of bi(e)) t.has(o) ? t.delete(o) : document.head.appendChild(n);
		...
		return Ke(M('script', r)).pipe(
			b((o) => {
				...
				if (o.src) {
					for (let i of o.getAttributeNames()) n.setAttribute(i, o.getAttribute(i));
					return (
						o.replaceWith(n),
						new F((i) => {
							n.onload = () => i.complete();
		...
		return (
			L(
				...
				history.state !== null || !a.hash
					? window.scrollTo(0, (p = (c = history.state) == null ? void 0 : c.y) != null ? p : 0)
		...
		return (
			L($(location.protocol !== 'file:'), Je('search'))
				...
				.subscribe(({ config: o, docs: n }) =>
					r.next({
						type: 0,
						data: { config: o, docs: n, options: { suggest: V('search.suggest') } },
					}),
				),
			r
		);
	...
	function Ti({ document$: e }) {
		let t = Te(),
			...
			o = r.pipe(
				m((n) => {
					let [, i] = t.base.match(/([^/]+)\/?$/);
					return n.find(({ version: s, aliases: a }) => s === i || a.includes(i)) || n[0];
				}),
			);
		r
			.pipe(
				m((n) => new Map(n.map((i) => [`${new URL(`../${i.version}/`, t.base)}`, i]))),
				b((n) =>
	...
	function Oi(e, { worker$: t, query$: r }) {
		...
		Je('search').subscribe((l) => {
			...
			o.pipe(te(r), Gr(t.pipe(Re(zt)))).subscribe(([{ items: l }, { value: f }]) => {
				switch (l.length) {
					case 0:
						s.textContent = f.length ? Me('search.result.none') : Me('search.result.placeholder');
						break;
					case 1:
		...
		return (
			...
			c
				...
				.subscribe((l) => {
					l.open === !1 && l.offsetTop <= i.scrollTop && i.scrollTo({ top: l.offsetTop });
				}),
			t
				.pipe(
					g(Sr),
		...
		try {
					...
					switch (c.type) {
						...
						case 'ArrowDown':
							if (typeof p == 'undefined') i.focus();
								...
								let l = [i, ...M(':not(details) > [href], summary, details[open] [href]', s)],
									f = Math.max(
										0,
										(Math.max(0, l.indexOf(p)) + l.length + (c.type === 'ArrowUp' ? -1 : 1)) %
											l.length,
									);
								l[f].focus();
							}
			...
			return L(a, Oi(s, { worker$: n, query$: a })).pipe(
				Ve(
					...
					...me('search-suggest', e).map((c) => Mi(c, { worker$: n, keyboard$: r })),
				),
			);
		} catch (n) {
	...
	function Ss(e, { viewport$: t, main$: r }) {
		...
		return z([r, t]).pipe(
			m(
				...
				]) => ((s = s + Math.min(n, Math.max(0, a - i)) - n), { height: s, locked: a >= i + n }),
			),
			...
			return (
				...
				fe(M('label[tabindex]', e))
					...
					.subscribe((l) => {
						...
						j(`[aria-labelledby="${l.id}"]`).setAttribute('aria-expanded', `${f.checked}`);
					}),
				V('content.tooltips') &&
					fe(M('abbr[title]', e))
						.pipe(
	...
	function Ls(e) {
		return (
			...
			(Os = H(() => {
				...
				return Hi(e.href).pipe(O((o) => __md_set('__source', o, sessionStorage)));
			}).pipe(
				ve(() => y),
	...
	function $i(e) {
		...
		return H(() => {
			...
			return (
				r.subscribe(({ facts: o }) => {
					t.appendChild(jn(o)), t.classList.add('md-source__repository--active');
				}),
				Ls(e).pipe(
					O((o) => r.next(o)),
					A(() => r.complete()),
			...
			.pipe(
				...
				b((a) =>
					H(() => {
						...
						return $(
							[...o].reduce((p, [l, f]) => {
								for (; c.length && o.get(c[c.length - 1]).tagName >= f.tagName; ) c.pop();
								let u = f.offsetTop;
								for (; !u && f.parentElement; ) (f = f.parentElement), (u = f.offsetTop);
			...
			.pipe(
				...
				m(([a, c]) =>
					a.prev.length < c.prev.length
						? { prev: c.prev.slice(Math.max(0, a.prev.length - 1), c.prev.length), next: [] }
						: { prev: c.prev.slice(-1), next: c.next.slice(0, c.next.length - a.next.length) },
				),
			);
	}
		...
		return H(() => {
			...
			if (
				(i.subscribe(({ prev: a, next: c }) => {
					for (let [p] of c)
						p.classList.remove('md-nav__link--passed'), p.classList.remove('md-nav__link--active');
			...
			return (
				V('navigation.tracking') &&
					t
						.pipe(W(s), ne('offset'), Ae(250), Ie(1), W(n.pipe(Ie(1))), vt({ delay: 250 }), te(i))
						.subscribe(([, { prev: a }]) => {
							let c = we(),
								p = a[a.length - 1];
							if (p && p.length) {
								...
								c.hash !== f && ((c.hash = f), history.replaceState({}, '', `${c}`));
	...
	V('navigation.instant') &&
		gi({ sitemap$: qi, location$: Kt, viewport$: ke, progress$: uo }).subscribe(ct);
	var Di;
	((Di = Or.version) == null ? void 0 : Di.provider) === 'mike' && Ti({ document$: ct });
	L(Kt, Ht)
		.pipe(nt(125))
		.subscribe(() => {
	...
	var ft = ai(Ce('header'), { viewport$: ke }),
		...
		$s = H(() =>
			L(
				...
				...me('header').map((e) => si(e, { viewport$: ke, header$: ft, main$: qt })),
				...
				...me('toc').map((e) => Ri(e, { viewport$: ke, header$: ft, main$: qt, target$: Ht })),
				...me('top').map((e) => Ii(e, { viewport$: ke, header$: ft, main$: qt, target$: Ht })),
			),
		),
		Ki = ct.pipe(
			b(() => $s),
