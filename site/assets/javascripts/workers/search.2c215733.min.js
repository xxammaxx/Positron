...
(() => {
	...
	var K = Math.pow,
		X = (t, e, r) =>
			e in t ? G(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r),
		_ = (t, e) => {
	...
	var we = (t, e, r, n) => {
		if ((e && typeof e == 'object') || typeof e == 'function')
			for (let i of Qe(e))
				!Z.call(t, i) &&
					i !== r &&
					G(t, i, { get: () => e[i], enumerable: !(n = Se(e, i)) || n.enumerable });
		return t;
	};
	var Pe = (t, e, r) => (
		(r = t != null ? xe(Ee(t)) : {}),
		we(e || !t || !t.__esModule ? G(r, 'default', { value: t, enumerable: !0 }) : r, t)
	);
	var W = (t, e, r) =>
		new Promise((n, i) => {
			var s = (u) => {
...
`,
							...
							for (var f = s[c], g = 0; g < u; g++) {
								...
								if (l == f || f == '*') {
									...
									l in n.output.edges
										...
										: ((d = new t.TokenSet()), (d.final = v), (n.output.edges[l] = d)),
			...
			(t.Index = function (e) {
				...
				(t.Index.prototype.query = function (e) {
					...
					for (var A = t.Set.complete, I = t.Set.empty, u = 0; u < this.fields.length; u++) {
						var y = this.fields[u];
					...
					for (
						...
						for (
							...
							i[d] === void 0
								...
								(w =
									(E * ((this._k1 + 1) * y)) /
									(this._k1 * (1 - this._b + this._b * (u / this.averageFieldLength[a])) + y)),
								(w *= m),
								(w *= x),
						...
						for (var o = 0; o < s.length; o++) {
							...
							for (var c = 0; c < u.length; c++) {
								...
								this.metadata[i][a][f] == null
									...
									: (this.metadata[i][a][f] = this.metadata[i][a][f].concat(e.metadata[i][a][f]));
							}
						}
					}
				}),
	...
	function le(t) {
		...
		for (let n of e.clauses)
			(n.usePipeline = !0),
				n.term.startsWith('*') &&
					((n.wildcard = lunr.Query.wildcard.LEADING), (n.term = n.term.slice(1))),
				n.term.endsWith('*') &&
					((n.wildcard = lunr.Query.wildcard.TRAILING), (n.term = n.term.slice(0, -1)));
		return e.clauses;
	}
	function he(t, e) {
		var i;
		...
		for (let s = 0; s < e.length; s++)
			for (let o of r) e[s].startsWith(o.term) && ((n[o.term] = !0), r.delete(o));
	...
	function fe(t, e) {
		...
		for (let s = 0; s < t.length; s++)
			for (let o = s + 1; o < t.length; o++) t.slice(s, o) in e && (n[s] = o - s);
		let i = [0];
	...
	var U = class {
		...
		search(e) {
			...
			return _({ items: [...n.values()] }, typeof i != 'undefined' && { suggest: i });
		}
	};
	var de;
	function Ie(t) {
